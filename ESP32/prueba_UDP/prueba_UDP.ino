...
//     Configuración RED   ///////////
///////////////////////////////////////
#define ssid "notenemosinternet"    //laboratorioUSM
#define password "nomelase"

#define IP_monitoreo "192.168.100.9"     //ip del pc
#define puerto_monitoreo 1234           //puerto de envio UDP monitoreo
#define IP_sucesor "192.168.100.18"   //ip del robot sucesor (LIDER)
...
void ciclo_de_control(){
  ...
  //HABILITA LA TRANSMSION DE DATOS ENTRE ROBOTS
